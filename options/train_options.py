...
class TrainOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--encoder_type', default='Encoder4EditingMobileNet', type=str, help='Which encoder to use')
        ...
        self.parser.add_argument('--lpips_type', default='alex', type=str, help='LPIPS backbone') # vgg
        ...
        self.parser.add_argument('--encoder_mobile', default=None, type=str, help='self encoder model checkpoint')
